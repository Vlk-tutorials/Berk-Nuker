# https://github.com/TT-Tutorials | https://discord.gg/3HvmaUxRv9
# Coded / Dev / Owner: valik#7497
# Copyright © Berk-nuker
#########################################################
...
try:
    ...
    input(f"\n[\x1b[95m#\x1b[95m\x1B[37m] Successfully Logged in as: [{Fore.LIGHTGREEN_EX}{login}{Fore.LIGHTGREEN_EX}]\n[\x1b[95m>\x1b[95m\x1B[37m] Press ENTER to Continue: ")
    pass
with open('data/logins.json') as f:
    config = json.load(f)
...
def spammer():
    ...
    print('')
    print('')
    Write.Print("                ______ ___________ _   __                                    \n", Colors.green_to_white, interval=0.000)
    Write.Print("                | ___ \  ___| ___ \ | / /                                       \n", Colors.green_to_white, interval=0.000)
    Write.Print("                | |_/ / |__ | |_/ / |/ /                                           \n", Colors.green_to_white, interval=0.000)
    Write.Print("                | ___ \  __||    /|    \                          \n", Colors.green_to_white, interval=0.000)
    Write.Print("                | |_/ / |___| |\ \| |\  \                              \n", Colors.green_to_white, interval=0.000)
    Write.Print("                \____/\____/\_| \_\_| \_/                                   \n", Colors.green_to_white, interval=0.000)
    Write.Print(f' > [v{THIS_VERSION}]                              \n', Colors.green_to_white, interval=0.000)
    Write.Print(f' > [https://discord.gg/3HvmaUxRv9]                 \n', Colors.green_to_white, interval=0.000)
    Write.Print(" > [https://github.com/Vlk-tutorials/Berk-Nuker]                       \n", Colors.green_to_white, interval=0.000)
    Write.Print("════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════", Colors.green_to_white, interval=0.000)
    print(f'''{Fore.LIGHTGREEN_EX}'''.replace('$', f'{Fore.LIGHTGREEN_EX}${Fore.LIGHTGREEN_EX}') + f'''
{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}1{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} Server Joiner   {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}9{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET}  Channel Spammer   {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}17{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} Patch Notes{Fore.RESET}         {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}25{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} Token Generator{Fore.RESET}
{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}2{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} Server Leaver   {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}10{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} DM Spammer        {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}18{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} About/Activity{Fore.RESET}      {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}26{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} Nitro Generator{Fore.RESET}
{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}3{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} Token Checker   {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}11{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} Friend Spammer    {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}19{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} Server Lookup{Fore.RESET}       {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}27{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} QR Token Grabber{Fore.RESET}
{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}4{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} Token Onliner   {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}12{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} HypeSquad Joiner  {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}20{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} Token Infomation{Fore.RESET}    {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}28{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} Member ID Scraper{Fore.RESET}
{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}5{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} Token Grabber   {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}13{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} Reaction Spammer  {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}21{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} Status Changer{Fore.RESET}      {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}29{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} PFP Changer{Fore.RESET}
{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}6{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} Server MassDM   {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}14{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} NickName Changer  {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}22{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} Group Spammer{Fore.RESET}       {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}30{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} About{Fore.RESET}
{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}7{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} Account Nuker   {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}15{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} Webhook Spammer   {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}23{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} Auto Login{Fore.RESET}          {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}31{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET}{lr} THREADS{Fore.RESET}
{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}8{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} Server Nuker    {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}16{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} VC Spammer        {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}24{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET} DM Deleter{Fore.RESET}          {b}|{Fore.RESET}{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}32{Fore.RESET}{Fore.LIGHTGREEN_EX}]{Fore.RESET}{lr} EXIT{Fore.RESET}''')
    Write.Print("════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════", Colors.green_to_white, interval=0.000)
    ...
    choice = input(f'{Fore.LIGHTGREEN_EX}[{Fore.LIGHTGREEN_EX}>{Fore.LIGHTGREEN_EX}]{w} Choice?: ')
...
#   JOINER  
    if choice == '1':
        ...
        gh = input(f"""
Joiner is in the Paid Version of Berk-Nuker\nIf You Are Wanting to Purchase Make Sure to join the discord !
                                   
[\x1b[95m1\x1b[95m\x1B[37m] BERK-Nuker discord
[\x1b[95m2\x1b[95m\x1B[37m] Exit
  
[\x1b[95m>\x1b[95m\x1B[37m] Choice?: """)

        if gh in ['01','1']:
            webbrowser.open('https://discord.gg/3HvmaUxRv9')
        elif gh in ['02','2']:
            exit = spammer()
        else:
         print('')
...
#   TOKEN ONLINER
    if choice == '4':
            ...
            config = {
                ...
                "state": "https://discord.gg/3HvmaUxRv9",
                "name": "BERK NUKER",
            }
            ...
            class Onliner:
                ...
                def __online__(self):
                    ...
                    print(f"\n[{g}+{Fore.LIGHTGREEN_EX}] Online | {self.token}")
...
#   TOKEN GRABBER
    if choice == '5':
        ...
        print(f"\n[{lr}!{Fore.LIGHTGREEN_EX}] Token Grabber is Currently Down... Updating Soon!")
...
#   SERVER MASSDM
    if choice == '6':
        ...
        print(f"\n[{lr}!{Fore.LIGHTGREEN_EX}] Server MassDM is Currently Down... Updating Soon!")
...
#   DM SPAMMER
    if choice == '10':
        ...
        gh = input(f"""
DM Spammer is in the Paid Version of BERK-Nuker!\nIf You Are Wanting to Purchase Make Sure to Checkout the Offical BERK-Nuker Website!

[\x1b[95m1\x1b[95m\x1B[37m] BERK-Nuker Dscird
[\x1b[95m2\x1b[95m\x1B[37m] Exit
...
#   ABOUT/ACTIVITY
    if choice == '18':
        ...
        if changg == '1':
            ...
            tokens = open('tokens.txt', 'r').read().splitlines()
            ab = input(f'[{Fore.LIGHTGREEN_EX}>]{Fore.RESET} About: ')
            for token in tokens:
