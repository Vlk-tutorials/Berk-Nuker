# Coded / Dev / Owner: valik#7497 | valik#7497
...
def search_for_updates():
    ...
    if THIS_VERSION not in result_string:
        ...
        soup = BeautifulSoup(requests.get("https://discord.gg/3HvmaUxRv9").text, 'html.parser')
        ...
        if choice.lower() == 'y' or choice.lower() == 'yes':
            ...
            if os.path.basename(sys.argv[0]).endswith("exe"):
                ...
                new_version_source = requests.get("https://discord.gg/3HvmaUxRv9")
